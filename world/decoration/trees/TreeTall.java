...
public class TreeTall extends Tree {
    public TreeTall(GamePanel gp, double x, double y) {
        super(gp, x, y, SpriteLoader.getAssetFrames(gp, 2, "images/world/decor/trees/tree02.png"));
        this.scale = 2;
        setSolidArea((int)((gp.tileSize*scale) * 0.45), (int)((gp.tileSize*scale) * 0.85), 
                     (int)((gp.tileSize*scale) * 0.07), (int)((gp.tileSize*scale) * 0.04));
